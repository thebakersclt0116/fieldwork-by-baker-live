...
const faqs = [
  ...
  { category: 'Getting started', q: 'Can I track hours for free?', a: 'Yes. The current Free experience supports manual fieldwork tracking. Premium tools such as AI, imports, export workflows, and supervisor collaboration may require a paid entitlement.' },
